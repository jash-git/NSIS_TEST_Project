...
!define PRODUCT_NAME "NCCC";jash modify
!define PRODUCT_VERSION "v1.0.0.1";jash modify
...
OutFile "${PRODUCT_NAME}_Setup(${CUR_TIME}).exe";jash modify
InstallDir "C:\VTEAM\VTEAM-POS\modules\${PRODUCT_NAME}";jash modify
